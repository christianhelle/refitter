...
The following example shows how to generate a single client from multiple OpenAPI specifications:
...
When using `openApiPaths`, the documents are merged into a single generated client, where the first document wins on schema conflicts.
...
- `generateClients` - a boolean indicating whether Refit interface(s) should be generated. Default is `true`
- `generateXmlDocCodeComments` - a boolean indicating whether XML doc comments should be generated. Default is `true`
- `generateStatusCodeComments` - a boolean indicating whether status code comments should be generated in the XML docs. Default is `true`
...
- `contractsOutputFolder` - a string describing a relative path to a desired output folder for the Contracts.cs file. By the default, this uses the value specified in `outputFolder`
...
```json
{
    ...
    "properties": {
        "openApiPath": {
            "type": "string",
            "description": "The path to the OpenAPI specification file. Required if openApiPaths is not specified."
        },
        "openApiPaths": {
            "type": "array",
            "items": {
            ...
            "description": "The paths to multiple OpenAPI specification files. When specified, the documents are merged into a single generated client. The first document wins on schema conflicts. Required if openApiPath is not specified."
        },
        "namespace": {
            "type": "string",
        ...
        "generateClients": {
            "type": "boolean",
            "description": "Indicates whether to generate Refit interface(s)."
        },
        ...
        "returnIAsyncEnumerable": {
            "type": "boolean",
            "description": "Indicates whether streaming responses generate IAsyncEnumerable. Default is true."
        },
