...
```js
{
  ...
  "generateExceptionStatusComments": true, // Optional. Default=true
...
- `generateExceptionStatusComments` - a boolean indicating whether the XML docs for thrown ApiExceptions contain detailed descriptions for every documented status code. Default is `true`
