...
public class GenerateCommandTests
{
    ...
    {
        var settingsFilePath = Path.Combine(Path.GetTempPath(), "TestApi", "petstore.refitter");
        var settings = new Settings
        {
    ...
    public void GetOutputPath_Should_Root_Relative_To_SettingsFile_When_OutputFolder_Is_Custom()
    {
        ...
        var expected = Path.Combine(Path.GetDirectoryName(settingsFilePath)!, "./CustomOutput", "PetStore.cs");
        result.Should().Be(expected);
    }
    ...
    public void GetOutputPath_Should_Use_SettingsFileName_When_OutputFilename_Is_Missing()
    {
        ...
        var expected = Path.Combine(Path.GetDirectoryName(settingsFilePath)!, "./Generated", expectedFilename);
        result.Should().Be(expected);
    }
