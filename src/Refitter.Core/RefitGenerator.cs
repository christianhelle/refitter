...
namespace Refitter.Core
{
    public class RefitGenerator
    {
        ...
        {
            var generator = CreateCSharpClientGenerator(document);
        ...
        private CSharpClientGenerator CreateCSharpClientGenerator(OpenApiDocument document)
        {
        ...
        private string GenerateClient(OpenApiDocument document, CSharpClientGenerator generator)
        {
        ...
        private void GenerateNamespaceImports(StringBuilder code)
        {
            code.AppendLine(
                    string.Join(
                        Environment.NewLine,
                        $"{Separator}using Refit;",
                        $"{Separator}using System.Threading.Tasks;",
                        $"{Separator}using System.Collections.Generic;"))
                .AppendLine();
        }
