...
internal sealed class GeneratorPipeline
{
        ...
        InterfaceGenerator interfaceGenerator)
    {
        ...
        var usesHttpResponseMessage = generatedCodes.Any(c => ReturnTypeGenerator.ReturnsHttpResponseMessage(c.Content));

        var code = new StringBuilder();
        GenerateAutoGeneratedHeader(settings, code);

        code.AppendLine()
            .AppendLine(RefitInterfaceImports.GenerateNamespaceImports(settings, usesHttpResponseMessage))
            .AppendLine();
