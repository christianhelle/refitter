...
public sealed class Settings : CommandSettings
{
    ...
    [Description("Don't generate IAsyncEnumerable for streaming responses")]
    [CommandOption("--no-async-enumerable")]
    [DefaultValue(false)]
    public bool NoIAsyncEnumerable { get; set; }
    ...
    /// </summary>
    [Description("Generate Authorization header for the given security scheme. When omitted, authentication headers will be generated for all security schemes.")]
