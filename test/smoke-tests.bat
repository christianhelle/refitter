...
:: V3.4 webhook filenames
set "v34wfilename0=webhook-example"
set "v34wfilename_count=1"
...
:: V3.4 webhook specs (skip MultipleInterfaces variants - webhook specs may lack regular API paths)
for %%f in (json yaml) do (
    for /l %%i in (0,1,0) do (
        set "cur_filename=!v34wfilename%%i!"
        set "file_path=.\OpenAPI\v3.4\!cur_filename!.%%f"
        ...
        if exist "!file_path!" (
            ...
            set "output_base=!output_base:.=!"
            call :capitalize output_base
            set "ns=!output_base!_v34_%%f"
            set "file_tag=v34_%%f_!output_base!"
